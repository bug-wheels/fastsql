...
public class FastSqlRepositoryRegistrar implements ImportBeanDefinitionRegistrar, BeanFactoryAware {
  ...
  public void registerBeanDefinitions(AnnotationMetadata annotationMetadata,
    ...
    AnnotationAttributes annoAttrs = AnnotationAttributes
      .fromMap(annotationMetadata.getAnnotationAttributes(EnableFastSql.class.getName()));
    ...
    for (Class clazz : classSet) {
      if (clazz.getAnnotation(Repository.class) != null) {
        beanFactory
          .registerSingleton(StringUtil.firstCharToLowerCase(clazz.getSimpleName()), FacadeProxy.newMapperProxy(clazz));
      }
    }
  }
